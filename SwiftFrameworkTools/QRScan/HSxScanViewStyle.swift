...
// MARK:- 扫码区域动画效果
public enum HSxScanViewAnimationStyle {
...
// MARK:- 扫码区域4个角位置类型
public enum HSxScanViewPhotoframeAngleStyle
{
...
public struct HSxScanViewStyle {
    // MARK: - -中心位置矩形框
    ...
    // @brief  扫码区域的4个角类型
    public var photoframeAngleStyle = HSxScanViewPhotoframeAngleStyle.Outer
    ...
    // @brief  扫码动画效果:线条或网格
    public var anmiationStyle = HSxScanViewAnimationStyle.LineMove
